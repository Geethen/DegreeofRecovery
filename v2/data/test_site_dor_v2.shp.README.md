# `test_site_dor_v2` dataset metadata

This README documents both:

- `test_site_dor_v2.csv` (full column names), and
- `test_site_dor_v2.shp` (DBF-safe abbreviated field names).

## File set

| File | Purpose |
|---|---|
| `test_site_dor_v2.csv` | Per-site DoR table with full column names |
| `test_site_dor_v2.shp` | Point geometry layer for GIS |
| `test_site_dor_v2.shx` | Shapefile index |
| `test_site_dor_v2.dbf` | Shapefile attributes |
| `test_site_dor_v2.prj` | CRS definition (EPSG:4326) |
| `test_site_dor_v2.cpg` | DBF text encoding |
