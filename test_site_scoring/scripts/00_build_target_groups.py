...
Output: test_site_scoring/data/target_groups.parquet  (one row per target site)
...
SHP = Path("/data/P-Prosjekter2/155020_recover/WP1/R/data/for_gee/"
           "samples_recover_w_ref_label.shp")
...
OUT = BASE / "test_site_scoring/data/target_groups.parquet"
