...
Output: test_site_scoring/data/v5_extra_refs_281_alphaearth.parquet
...
SAMPLER = BASE / "v5/scripts/sampling/sample_stable_references_v5.py"
TARGETS = BASE / "test_site_scoring/data/target_groups.parquet"
OUT = BASE / "test_site_scoring/data/v5_extra_refs_281_alphaearth.parquet"
LOG = BASE / "test_site_scoring/logs/06_extra_refs.log"
