...
Output: test_site_scoring/data/test_site_dor_ecoregion_2024.csv  (ref_vintage=2024).
"""
...
ECO_DIR_2024 = BASE / "test_site_scoring/data"          # ref_samples_eco{id}_2024.parquet
ECO_DIR_2022 = BASE / "v1-ecoregion/data"               # ref_samples_eco{id}.parquet (legacy)
...
OUT = BASE / "test_site_scoring/data/test_site_dor_ecoregion_2024.csv"
