...
Inputs:
  test_site_scoring/data/test_site_dor_buffer_3_8km.csv      (step 3)
  test_site_scoring/data/test_site_dor_ecoregion_2024.csv    (step 4)
  test_site_scoring/data/target_groups.parquet               (step 0)
Output:
  test_site_scoring/data/test_site_scores_combined.csv
"""
...
BUFFER = BASE / "test_site_scoring/data/test_site_dor_buffer_3_8km.csv"
ECO = BASE / "test_site_scoring/data/test_site_dor_ecoregion_2024.csv"
OUT = BASE / "test_site_scoring/data/test_site_scores_combined.csv"
