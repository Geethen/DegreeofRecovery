...
The analysis used three sets of class labels from the upstream abandonment workflow. The abandonment classes were 'crop-loss', for abandonment of cropland, and 'built-loss', for abandonment of built-up land and infrastructure. A third upstream label, 'stable', marked sites with no detected transition during 2018-2024. Because stable sites could belong to stable near-natural, stable cropland, or stable built-up classes, we assigned them to one of these three classes using agreement among independent land-cover and building-footprint products (Supplementary Table S1). Stable cropland and stable built-up sites were processed as control sites with the same workflow as built-loss and crop-loss, but they were not interpreted as recovery observations. Of 1,608 stable sites,; 1,471 had sufficient valid reference data and non-conflicting stable-site classes. Stable cropland and stable built-up sites served as controls because they should remain closer to their own non-natural state than to near-natural vegetation.
...
|---|---|---|---|---|
| ESA WorldCover v100 (Zanaga et al., 2021) | 10 m | 2020 | Cropland (40), built-up (50), other = natural | `ESA/WorldCover/v100` |
| ESA WorldCover v200 (Zanaga et al., 2022) | 10 m | 2021 | Cropland (40), built-up (50), other = natural | `ESA/WorldCover/v200` |
| Dynamic World V1 (Brown et al., 2022) | 10 m | 2024 annual mode | Crops (4), built (6), other = natural | `GOOGLE/DYNAMICWORLD/V1` |
| ESA WorldCereal temporary crops v100 (Van Tricht et al., 2023) | 10 m | 2021 | Cropland only (binary); no opinion on built vs natural | `ESA/WorldCereal/2021/MODELS/v100` |
...
The near-natural pool was defined as WorldCover pixels that were not cropland, built-up land, water, or pixels with evidence of recent loss based on the loss masks from the upstream analysis. The non-natural pool depended on the site class: cropland for cropland-loss or stable cropland sites, built-up land for built-up-loss or stable built-up sites, and the union of cropland and built-up land for stable natural sites.
...
- Van Tricht, K., Degerickx, J., Gilliams, S., Zanaga, D., Battude, M., Grosu, A., Brombacher, J., Lesiv, M., Bayas, J.C.L., Karanam, S. and Fritz, S., 2023. WorldCereal: a dynamic open-source system for global-scale, seasonal, and reproducible crop and irrigation mapping. *Earth System Science Data*, 15(12), pp.5491-5515.
