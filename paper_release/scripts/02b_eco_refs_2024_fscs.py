...
Output: outputs/data/ref_samples_eco{id}_2024.parquet  (suffix _2024).
...
NOTE: requires Google Earth Engine access and the RECOVER samples/ecoregions EE
assets. Not needed for the default reproduction path, which scores against the
already-2024 ref_samples_eco{id}_2024.parquet files.
"""
...
from _paths import DATA, OUT_DATA, OUT_LOGS, ROOT  # noqa: E402

SAMPLER = ROOT / "scripts" / "sampling" / "sample_reference_states.py"
