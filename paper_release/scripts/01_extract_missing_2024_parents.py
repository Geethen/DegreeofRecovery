...
Output: outputs/data/test_site_alphaearth_2024_missing.parquet
Columns: PLOTID, eco_id, A00..A63, year

NOTE: this output already ships precomputed at
data/cached/test_site_alphaearth_2024_missing.parquet. Re-running this script
requires a Google Earth Engine account with access to the AlphaEarth annual
embedding collection and is only needed to regenerate it from scratch.
"""
...
OUT = OUT_DATA / "test_site_alphaearth_2024_missing.parquet"
